...
def convert_json_to_txt(json_file_path, output_directory, image_width, image_height):
    CLASS_NAMES = ["vehicle_car", "vehicle_bike", "vehicle_bus", "vehicle_truck"]
    ...
    try:
        ...
        vehicle_type = json_data["value"]["object_Label"]["vehicle_type"]
    except KeyError:
    ...
    with open(txt_file_name, 'w') as new_file:
        ...
        new_data = "{}".format(str(CLASS_NAMES.index(vehicle_type)))
...
input_directory = 'dataset_vehicle/val/vehicle_annotations'
output_directory = 'dataset_vehicle/val/labels'
